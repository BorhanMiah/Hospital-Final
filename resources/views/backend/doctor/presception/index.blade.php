...
<section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="dataTable-top"><div class="dataTable-dropdown"></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div><br><a href={{route('presception.create')}} class="btn btn-info">Create presception</a></div>
                        <br>
                            ...
                            <table class="table table-striped dataTable-table" id="table1">
                                ...
                                @foreach($presception as $row)
                                      ...
                                      <td>
		                               ...
		                               <a href="{{route('presception.delete', ['id'=>$row->id])}}" class="btn btn-danger">Delete</a>
