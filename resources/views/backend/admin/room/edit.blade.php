...
<section id="basic-horizontal-layouts">
        <div class="row match-height">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-horizontal" action={{route('room.update',$data->id)}} method="post">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                            <input type="text" id="name" class="form-control" name="room_no" value="{{$data->room_no}}">
