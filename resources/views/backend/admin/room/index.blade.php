...
<section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="dataTable-top"><div class="dataTable-dropdown"></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div><br><a href={{route('room.create')}} class="btn btn-info">Add room</a></div>
                        <br>
                            ...
                            <table class="table table-striped dataTable-table" id="table1">
                                <thead>
                                    <tr>
                                        <th style="width: 25.1523%;">#</th>
                                        <th style="width: 25.1523%;">Room no</th>
                                        <th style="width: 25.1523%;">Doctor name</th>
                                        <th style="width: 25.1523%;">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach ($rooms as $key => $room)
                                    ...
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $room->room_no }}</td>
                                    <td>{{ $room->doctor->name }}</td>
                                    <td>
                                        <a href={{route('room.edit', $room->id)}} class="btn btn-success round">Edit</a>
                                        <a href={{route('room.delete', $room->id)}} class="btn btn-danger round">Delete</a>
                                    </td>
                                    </tr>
                                @endforeach
                                </tbody>
