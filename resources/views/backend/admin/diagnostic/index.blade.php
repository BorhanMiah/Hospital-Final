...
<section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="dataTable-top"><div class="dataTable-dropdown"></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div><br><a href={{route('diagnostic.create')}} class="btn btn-info">Add diagnostic</a></div>
                        <br>
                            ...
                            <table class="table table-striped dataTable-table" id="table1">
                                <thead>
                                    <tr>
                                        <th style="width: 10.1023%;">Diagnostic Id</th>
                                        <th style="width: 10.1023%;">Patient Name</th>
                                        <th style="width: 10.1023%;">Date</th>
                                        <th style="width: 10.1023%;">Test Name</th>
                                ...
                                @foreach($diagnostic as $row)
                                      ...
                                      <tr>
		                               ...
		                               <a href="{{route('diagnostic.delete', ['id'=>$row->id])}}" class="btn btn-danger">Delete</a>
                                         </td>
                                        </tr>
