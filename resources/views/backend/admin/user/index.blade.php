...
<section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="dataTable-top"><div class="dataTable-dropdown"></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div><br><a href={{route('admin.user.create')}} class="btn btn-info">Add schedule</a></div>
                        <br>
                            ...
                            <table class="table table-striped dataTable-table" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10.1023%;">Name</th>
                                        <th style="width: 10.1023%;">Email</th>
                                        <th style="width: 10.1023%;">Role</th>
