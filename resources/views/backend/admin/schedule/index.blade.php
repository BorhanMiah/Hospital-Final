...
<section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="dataTable-top"><div class="dataTable-dropdown"></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div><br><a href={{route('schedule.create')}} class="btn btn-info">Add schedule</a></div>
                        <br>
                            ...
                            <table class="table table-striped dataTable-table" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10.1023%;">Doctor name</th>
                                        <th style="width: 10.1023%;">Day</th>
                                        <th style="width: 10.1023%;">Time</th>
                                ...
                                @foreach ($schedules as $key => $schedule)
                                    ...
                                    <td>{{ $schedule->time }}</td>
                                    <td>
                                        <a href={{route('schedule.edit', $schedule->id)}} class="btn btn-success round">Edit</a>
                                        <a href={{route('schedule.delete', $schedule->id)}} class="btn btn-danger round">Delete</a>
                                    </td>
                                    </tr>
                                @endforeach
                                </tbody>
