 <footer class="ftco-footer ftco-section img" style="background-image: url(frontend/images/footer-bg.jpg);">
    	<div class="overlay"></div>
      <div class="container-fluid px-md-5">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Rowshan Hospital</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="department"><span class="icon-long-arrow-right mr-2"></span>Departments</a></li>
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Doctors</a></li>
                <li><a href="home"><span class="icon-long-arrow-right mr-2"></span>Reception</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Ghorashal, Polash, Narsingdi, Bangladesh</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+88 02 8836444, +88 02 8836000</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope pr-4"></span><span class="text">rowshanhospital@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Rowshan Hospital Limited</a>
